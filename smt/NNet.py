...
class NNetWrapper(NeuralNet):
    ...
    def train(self, examples):
        ...
        for epoch in range(args.epochs):
            ...
            # t = tqdm(range(batch_count), desc='Training Net') # currently does not include this training tracking log; may add some training info later
